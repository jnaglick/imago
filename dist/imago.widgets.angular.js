...
imagoVideo = (function() {
  function imagoVideo($q, $timeout, $window, imagoUtils) {
    return {
      ...
      link: function(scope, element, attrs) {
        var compileData, defaults, detectCodec, render, resize, self, videoOpts, visiblePromise;
        self = {};
        videoOpts = {};
        defaults = {
          autobuffer: null,
        ...
        compileData = function(data) {
          ...
          scope.loading = false;
          if (videoOpts.lazy) {
            return visiblePromise.then((function(_this) {
              return function(value) {
                self.visibleFunc();
    ...
    this.assets = {
      ...
      batch: (function(_this) {
        return function(list) {
          return $http.put("" + _this.host + "/api/assets/update", {
            assets: list
          });
        };
      })(this)
    ...
    _.forEach(query, (function(_this) {
      return function(value) {
        return promises.push(_this.getLocalData(value).then(function(result) {
          return fetches.push(_this.imagoWorker.reorder(result.assets, result.sortorder).then(function(response) {
