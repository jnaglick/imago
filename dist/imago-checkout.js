  ...
  function Costs() {
    return {
      ...
      controller: function($scope, $element, $attrs) {
        if (!$attrs.hideShippingIfNotCountry) {
          return $scope.hideShippingIfNotCountry = false;
        }
      }
    };
  }
