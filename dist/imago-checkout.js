...
Calculation = (function() {
  ...
  function Calculation($q, $state, $http, $auth, imagoUtils, imagoSettings) {
    ...
    this.calcShipping = __bind(this.calcShipping, this);
  ...
  Calculation.prototype.applyCoupon = function(coupon, costs) {
    var code, codes, meta, percentvalue, value, _ref;
    if (!coupon) {
      return;
    }
    meta = coupon.meta;
    ...
    if (meta.type === 'flat') {
      ...
      codes = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          code = _ref[_i];
          _results.push(code.toUpperCase());
        }
        return _results;
      })();
      if (meta.code && (_ref = this.shipping_options.code.toUpperCase(), __indexOf.call(codes, _ref) >= 0)) {
